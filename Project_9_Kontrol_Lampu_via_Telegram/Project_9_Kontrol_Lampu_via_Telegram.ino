...
const char* ssid     = "LED"; // ganti dengan WiFi anda
const char* password = "1234555555";//ganti dengan password anda

// ganti dengan Token anda
const char BotToken[] = "987675779:AAHqxmGabQRCqEPiFdYrUQLPVVY0tiJURsY";
